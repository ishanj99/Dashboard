...
const RoomDataPanel = ({ sensorData, roomId }) => {
  ...
  if (!sensorData) return <Box p={4} flex={1}><Typography>LOADING...</Typography></Box>;

  return (
    <Box key={roomId} p={4} flex={5} bgcolor="#ecf0f1" sx={{ 
      overflow: 'auto',
      height: '100%',
      boxSizing: 'border-box'
    }}>
      <Typography variant="h4" gutterBottom>{roomId} - Live Data</Typography>
